...
class TestNode(Container):
    ...
    def create_cmd(self):
        return [
            ...
            "ceph-devstack",
            "--mac-address",
            f"02:00:00:00:00:{self.index:02x}",
            "--hostname",
            self.name.replace("_", "-"),
            "--systemd=always",
            "--cgroupns=host",
            ...
            "-v",
            "/sys/devices/virtual/misc/kvm:/sys/devices/virtual/misc/kvm",
            "-v",
            ...
            *[f"--device={device}" for device in self.devices],
            ...
            self.name.replace("_", "-"),
            "-e",
            f"TESTNODE_NAME={self.name.replace('_', '-')}",
            "--ulimit",
            "nofile=65536:65536",
            "--ulimit",
            "core=-1:-1",
